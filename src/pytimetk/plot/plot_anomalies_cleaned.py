...
def plot_anomalies_cleaned(
    ...
    if isinstance(data, pd.core.groupby.generic.DataFrameGroupBy):
        ...
        group_names = None
        data = data.copy()
        data = data[[date_column, 'observed', 'observed_clean']]
    ...
    if group_names is not None:
        data_prepared = data_prepared.groupby(group_names)
    
    fig = data_prepared.plot_timeseries(
        date_column = date_column, 
        value_column = '_val',
        
        color_column = '_var',
        color_palette = [line_color, line_color_cleaned],
