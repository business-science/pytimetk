...
| engine        | (auto, pandas, polars)                                         | Specifies the backend computation library for rolling window functions. When "auto" (default) the backend is inferred from the input data type. Use "pandas" or "polars" to force a specific backend.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `'auto'`   |
