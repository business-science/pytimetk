...
| | |
| --- | --- |
| [anomalize](anomalize.qmd#pytimetk.anomalize) | The `anomalize` function is used to detect anomalies in time series data, either for a single time |
| [plot_anomalies](plot_anomalies.qmd#pytimetk.plot_anomalies) | The `plot_anomalies` function is used to plot anomalies in a time series data using either Plotly, |
| [plot_anomalies_decomp](plot_anomalies_decomp.qmd#pytimetk.plot_anomalies_decomp) | The `plot_anomalies_decomp` function takes in data from the `anomalize()` function, and |
...
| [augment_leads](augment_leads.qmd#pytimetk.augment_leads) | Adds lags to a Pandas DataFrame or DataFrameGroupBy object. |
...
| | |
| --- | --- |
| [augment_ewm](augment_ewm.qmd#pytimetk.augment_ewm) | Add Exponential Weighted Moving (EWM) window functions to a DataFrame or GroupBy object. |
...
| [parallel_apply](parallel_apply.qmd#pytimetk.parallel_apply) | The `parallel_apply` function parallelizes the application of a function on grouped dataframes using |
