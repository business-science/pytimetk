...
| [augment_ppo](augment_ppo.qmd#pytimetk.augment_ppo) | Calculate PPO using pandas or polars backends. |
| [augment_rsi](augment_rsi.qmd#pytimetk.augment_rsi) | Calculate RSI for one or more columns using pandas or polars backends. |
