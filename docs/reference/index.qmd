...
| | |
| --- | --- |
| [get_available_datasets](get_available_datasets.qmd#timetk.datasets.get_datasets.get_available_datasets) | Get a list of 12 datasets that can be loaded with `pytimetk.load_dataset`. |
