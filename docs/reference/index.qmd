...
| [augment_rolling](augment_rolling.qmd#pytimetk.augment_rolling) | Apply one or more rolling functions and window sizes to one or more columns of a DataFrame. |
...
| [get_frequency_summary](get_frequency_summary.qmd#pytimetk.get_frequency_summary) | Returns a summary including the inferred frequency, median time difference, scale, and unit. |
...
| [get_pandas_frequency](get_pandas_frequency.qmd#pytimetk.get_pandas_frequency) | Get the frequency of a pandas Series or DatetimeIndex. |
...
| [timeseries_unit_frequency_table](timeseries_unit_frequency_table.qmd#pytimetk.timeseries_unit_frequency_table) | The function `timeseries_unit_frequency_table` returns a pandas DataFrame with units of time and |
...
| | |
| --- | --- |
| [get_available_datasets](get_available_datasets.qmd#pytimetk.datasets.get_datasets.get_available_datasets) | Get a list of 12 datasets that can be loaded with `pytimetk.load_dataset`. |
| [load_dataset](load_dataset.qmd#pytimetk.datasets.get_datasets.load_dataset) | Load one of 12 Time Series Datasets. |