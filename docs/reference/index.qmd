...
| [plot_anomaly_decomp](plot_anomaly_decomp.qmd#pytimetk.plot_anomaly_decomp) | The `plot_anomaly_decomp` function takes in data from the `anomalize()` function, and |
