...
| [augment_rolling_apply](augment_rolling_apply.qmd#pytimetk.augment_rolling_apply) | Apply one or more rolling functions and window sizes to one or more columns of a DataFrame. |
| [augment_expanding](augment_expanding.qmd#pytimetk.augment_expanding) | Apply one or more expanding functions and window sizes to one or more columns of a DataFrame. |
