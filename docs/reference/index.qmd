...
| [augment_diffs](augment_diffs.qmd#pytimetk.augment_diffs) | Adds differences to a Pandas DataFrame or DataFrameGroupBy object. |
...
| [augment_atr](augment_atr.qmd#pytimetk.augment_atr) | The `augment_atr` function is used to calculate Bollinger Bands for a given dataset and return |
