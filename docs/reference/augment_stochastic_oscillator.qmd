...
| date_column   | str or ColumnSelector                  | Name of the column containing date information (selectors supported).                                                                      | _required_ |
| high_column   | str or ColumnSelector                  | Column containing high prices.                                                                                                             | _required_ |
| low_column    | str or ColumnSelector                  | Column containing low prices.                                                                                                              | _required_ |
| close_column  | str or ColumnSelector                  | Column containing closing prices. Resulting columns are prefixed with this name.                                                           | _required_ |
