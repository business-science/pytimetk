...
| high_column   | str or ColumnSelector                  | Column names used to compute the indicator. Selectors must resolve to a single column each.                                                   | _required_ |
| low_column    | str or ColumnSelector                  | Column names used to compute the indicator. Selectors must resolve to a single column each.                                                   | _required_ |
| close_column  | str or ColumnSelector                  | Column names used to compute the indicator. Selectors must resolve to a single column each.                                                   | _required_ |
