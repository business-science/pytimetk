...
| freq          | str or pd.DateOffset          | Frequency of the future dates. When ``None``, the cadence is inferred from the input data (respecting ``force_regular``). Accepts pandas offsets or human-friendly strings e.g. ``"2 weeks"``.                                                                                                                                                                                                                                     | `None`     |
