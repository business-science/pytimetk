...
| date_column   | str or ColumnSelector                  | Name of the column containing date information. Accepts tidy selectors.                                                                    | _required_ |
| high_column   | str or ColumnSelector                  | Column names/selectors used to compute the true range and ATR.                                                                             | _required_ |
| low_column    | str or ColumnSelector                  | Column names/selectors used to compute the true range and ATR.                                                                             | _required_ |
| close_column  | str or ColumnSelector                  | Column names/selectors used to compute the true range and ATR.                                                                             | _required_ |
