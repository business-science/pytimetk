# get_trend_frequency { #pytimetk.get_trend_frequency }

`get_trend_frequency(idx, force_regular=False, numeric=False)`
...
|-----------------|--------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| `idx`           | Union\[pd.Series, pd.DatetimeIndex\] | The `idx` parameter can be either a pandas Series or a pandas DatetimeIndex. It represents the time index for which you want to calculate the trend frequency.                                                                                                                                         | _required_ |
