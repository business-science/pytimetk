...
| date_column | str or ColumnSelector                  | Column containing the timestamps used to determine padding bounds.                                                                                                                                                                                                                                                                                                                                                                                                                   | _required_ |
| freq        | str                                    | Frequency for padding. Accepts pandas aliases (``"H"``, ``"MS"``, ...) or human-friendly durations like ``"15 minutes"`` or ``"3 days"``.  - S: secondly frequency - min: minute frequency - H: hourly frequency - B: business day frequency - D: daily frequency - W: weekly frequency - M: month end frequency - MS: month start frequency - BMS: Business month start - Q: quarter end frequency - QS: quarter start frequency - Y: year end frequency - YS: year start frequency | `'D'`      |
| start_date  | str                                    | Optional bounds for padding. Accepts ISO strings or durations relative to the observed min/max (e.g., ``"start: 1 month ago"``).                                                                                                                                                                                                                                                                                                                                                     | `None`     |
| end_date    | str                                    | Optional bounds for padding. Accepts ISO strings or durations relative to the observed min/max (e.g., ``"start: 1 month ago"``).                                                                                                                                                                                                                                                                                                                                                     | `None`     |
| fillna      | scalar                                 | When provided, all newly padded rows have their non-date/group columns filled with this value instead of the default forward/backward fill.                                                                                                                                                                                                                                                                                                                                          | `None`     |
