...
| date_column   | str or ColumnSelector                  | Name of the date column used to determine ordering prior to shifting. Accepts tidy selectors for convenience.                                                                                                                 | _required_ |
| value_column  | str, ColumnSelector, or list           | One or more column names/tidy selectors whose lead values will be appended.                                                                                                                                                   | _required_ |
