...
| date_column   | str or ColumnSelector                  | Name of the column containing date information (tidy selectors supported) used to preserve the original ordering.                                                                                                     | _required_ |
| close_column  | str, ColumnSelector, or list           | Column(s) containing closing prices on which the ROC is computed. Lists or multiple selectors compute an ROC per column.                                                                                              | _required_ |
