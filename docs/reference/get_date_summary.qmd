...
| `engine` | str                           | The `engine` parameter is used to specify the engine to use for returning a summary of the date-related information. It can be either "pandas" or "polars". - The default value is "pandas". - When "polars", the function will internally use the `polars` library for generating the date-related information. | `'pandas'` | 
