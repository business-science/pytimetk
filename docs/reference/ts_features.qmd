...
`ts_features(data, date_column, value_column, features=None, freq=None, scale=True, threads=1)`
...
| `threads`      | Optional\[int\]                                          | The `threads` parameter is an optional parameter that specifies the number of threads to use for parallel processing. If is `None`, the function will use the default number of threads available on the system.                                                                                                                                                                                                                                                                                    | `1`        |
