...
| date_column   | str or ColumnSelector                  | Name of the column containing date information (tidy selectors supported).                         | _required_ |
| close_column  | str or ColumnSelector                  | Name of the column containing closing price data. Selector inputs must resolve to a single column. | _required_ |
