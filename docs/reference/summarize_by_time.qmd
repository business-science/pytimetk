...
| Name | Description |
| --- | --- |
| [summarize_by_time](#timetk.summarize_by_time.summarize_by_time) | The `summarize_by_time` function aggregates data by a specified time period and one or more numeric |
