...
| Name | Description |
| --- | --- |
| [summarize_by_time](#timetk.summarize_by_time.summarize_by_time) | Summarize a DataFrame or GroupBy object by time. |

### summarize_by_time { #timetk.summarize_by_time.summarize_by_time }

`summarize_by_time.summarize_by_time(data, date_column, value_column, rule='D', agg_func='sum', kind='timestamp', wide_format=False, fillna=0, flatten_column_names=True, reset_index=True, *args, **kwargs)`
