...
| date_column       | str or ColumnSelector                                    | Name of the datetime column, or a tidy selector resolving to one column.                                                                           | _required_          |
| value_column      | str or ColumnSelector                                    | Numeric column to diagnose, or a tidy selector resolving to one column.                                                                            | _required_          |
