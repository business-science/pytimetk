...
- Introduced **Feature Store & Caching (Beta)** to persist expensive feature engineering steps and reload them on demand. The API and on-disk format may evolve before general availability—please share feedback so we can stabilize it quickly.
