...
- `plot_anomaly_decomp`: A scalable visualization tool for inspecting the observed, seasonal, trend, and remainder decomposition, which are useful for telling you whether or not anomalies are being detected to your preference.
...
- `augment_rolling()`: Gains a polars engine.
- `augment_expanding()`: Gains a polars engine. 
- `augment_timeseries_signature()`: Gains a polars engine.
